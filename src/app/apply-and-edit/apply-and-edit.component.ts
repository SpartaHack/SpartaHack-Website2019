...
export class ApplyAndEditComponent implements OnInit {
    ...
    raceList: Item[] = [
        ...
        { item_id: 2, item_text: 'Black or African American' },
        { item_id: 3, item_text: 'Hispanic or Latino' },
        { item_id: 4, item_text: 'American Indian or Alaska Native' },
        { item_id: 5, item_text: 'Asian' },   
        { item_id: 6, item_text: 'Pacific Islander' },
        { item_id: 7, item_text: 'Other' },
        { item_id: 8, item_text: 'Prefer not to Specify' }
    ]
    selectedRaces: Item[] = [ ]
    raceDropdownSettings = {
        singleSelection: false,
        idField: 'item_id',
        textField: 'item_text',
        itemsShowLimit: 3,
    ...
    onCollegeType() {
        this.filteredColleges = this.colleges.filter(college => college.toLowerCase().includes(this.application.university.toLowerCase()))
    }
...
"University of Alabama System-Birmingham",
"University of Alabama System-Huntsville",
"University of Alabama System-Tuscaloosa",
...
"Arizona State UniversityDowntown Phoenix",
"Arizona State UniversityPolytechnic",
...
"University of Arkansas System-Fayetteville",
"University of Arkansas System-Fort Smith",
"University of Arkansas System-Little Rock",
"University of Arkansas System-Medical Sciences",
"University of Arkansas System-Monticello",
...
"University of Colorado System-Colorado Springs",
...
"Purdue College of Technology-Indianapolis",
"Purdue College of Technology-Kokomo",
"Purdue College of Technology-Lafayette",
...
"City College",
"City University Graduate School & University Center",
"Clarkson University",
"Colgate University",
...
"Universitario Ana G. Mendez-Universidad del Este",
"Universitario Ana G. Mendez-Universidad Metropolitana",
"Universitario Ana G. Mendez-Universidad del Turabo",
...
"Tele-Université",
"Université du Quebec à Abitibi-Temiscamingue",
...
"Monterrey Institute of Technology and Higher Education-Monterrey Campus",
